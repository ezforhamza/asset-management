...
function SuperUserLoginPage() {
	...
	if (token.accessToken && userInfo.role === UserRole.SUPER_USER) {
		...
		<div className="relative grid min-h-svh lg:grid-cols-2 bg-background">
					...
					<div className="w-full max-w-sm">
						<LoginProvider>
							<LoginForm
								...
								redirectTo="/super-user/dashboard"
								changePasswordPath="/super-user/change-password"
							/>
							<ForgotPasswordForm />
						</LoginProvider>
					</div>
			...
			<div className="relative hidden bg-gradient-to-br from-primary/90 to-primary lg:flex lg:flex-col lg:items-center lg:justify-center lg:p-12">
				<div className="text-center text-white">
					<Icon icon="solar:headphones-round-bold-duotone" className="h-24 w-24 mx-auto mb-6 opacity-90" />
					<h2 className="text-3xl font-bold mb-4">Support Team Portal</h2>
					<p className="text-lg opacity-80 max-w-md">
						View assets and verification history across all client companies to deliver fast, effective support.
					</p>
					<div className="mt-8 grid grid-cols-3 gap-6 text-center">
						...
						<div>
							...
							<div className="text-sm opacity-70">Only</div>
						</div>
					</div>
				</div>
			</div>
